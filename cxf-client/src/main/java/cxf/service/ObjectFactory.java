...
public class ObjectFactory {
    ...
    private final static QName _SumResponse_QNAME = new QName("http://service.cxf/", "sumResponse");
    private final static QName _Login_QNAME = new QName("http://service.cxf/", "login");
    private final static QName _Multiply_QNAME = new QName("http://service.cxf/", "multiply");
    private final static QName _Sum_QNAME = new QName("http://service.cxf/", "sum");
    private final static QName _MultiplyResponse_QNAME = new QName("http://service.cxf/", "multiplyResponse");
    private final static QName _LoginResponse_QNAME = new QName("http://service.cxf/", "loginResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf/", name = "loginResponse")
